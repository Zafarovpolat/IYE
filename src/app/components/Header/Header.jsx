        ...
        <>
            ...
            >
                <div className={`${styles.container} container`}>
                    ...
                    <nav className={`${styles.nav} ${isMenuOpen ? styles.navHidden : ''}`}>
                    ...
                    <div className={`${styles.social} ${styles.social1}`}>
                        ...
                        >
                            ...
                            >
                                {isMenuOpen ? (
                                    ...
                                    <>
                                        <path d="M4 6L20 6" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                        <path d="M4 12L20 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                        <path d="M4 18L20 18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" />
                                    </>
                                )}
                            </svg>
                        </button>
                ...
                {isMenuOpen && (
                    ...
                    >
                        <div className={`${styles.container} container`}>
                            ...
                            <div className={`${styles.social} ${styles.social2}`}>
                                <a href="#" className={styles.socialIcon}>
                                    <svg
                                        width="24"
                                        height="24"
